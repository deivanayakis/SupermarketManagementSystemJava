...
public class Cosmetics extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(c1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, 80, 30));
        ...
        getContentPane().add(c2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 210, 110, 30));

        c3.setBackground(new java.awt.Color(255, 255, 255));
        c3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        c3.setText("Lip Stick");
        c3.setOpaque(true);
        ...
        getContentPane().add(c3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 250, 120, 30));
        ...
        getContentPane().add(c4, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 290, 120, 30));

        c5.setBackground(new java.awt.Color(255, 255, 255));
        c5.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        c5.setText("Moisturizer");
        c5.setOpaque(true);
        ...
        getContentPane().add(c5, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 330, 150, 30));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/opticosmeti.jpg"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        try
        {
            if(c1.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Kajal is not available now!!");
                }
                else
                {
            ...
            if(c2.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Eyeliner is not available now!!");
                }
                else
                {
            ...
            if(c3.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Lip Stick is not available now!!");
                }
                else
                {
            ...
            if(c4.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Perfume is not available now!!");
                }
                else
                {
            ...
            if(c5.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Moisturizer is not available now!!");
                }
                else
                {
