...
public class Vegetables extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(c2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 210, 100, -1));
        ...
        getContentPane().add(c3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 250, 110, -1));

        c4.setBackground(new java.awt.Color(255, 255, 255));
        c4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        c4.setText("Cauliflower");
        c4.setOpaque(true);
        ...
        getContentPane().add(c4, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 290, 150, -1));

        c5.setBackground(new java.awt.Color(255, 255, 255));
        c5.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        c5.setText("Butter Beans");
        c5.setOpaque(true);
        ...
        getContentPane().add(c5, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 330, 160, -1));
        ...
        p3.setText("203");
        p3.setOpaque(true);
        getContentPane().add(p3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 250, 40, 20));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/veg.jpg"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        try
        {
            if(c1.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Carrot is not available now!!");
                }
                else
                {
            ...
            if(c2.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Potato is not available now!!");
                }
                else
                {
            ...
            if(c3.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Tomato is not available now!!");
                }
                else
                {
            ...
            if(c4.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Cauliflower is not available now!!");
                }
                else
                {
            ...
            if(c5.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Butter Beans is not available now!!");
                }
                else
                {
            ...
            if(c6.isSelected())
            {
                ...
                {
                    i=3;
                    JOptionPane.showMessageDialog(null,"Sorry Onion is not available now!!");
                }
                else
                {
